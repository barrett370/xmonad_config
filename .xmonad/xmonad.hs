...
myStartupHook :: X ()
myStartupHook = do
	  spawnOnce "picom --config /home/sam/.config/picom/config.conf &"
	  spawnOnce "xrandr --output Virtual-1 --mode 1920x1200 &"
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar /home/sam/.config/xmobar/xmobarrc0"
